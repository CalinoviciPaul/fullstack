...
import ro.irian.fullstack.pizza.domain.*;
...
import ro.irian.fullstack.pizza.repository.PizzaCrudRepository;
import ro.irian.fullstack.pizza.repository.PizzaRepository;
...
public class PizzaServiceImpl implements PizzaService {
    ...
    public void createTestdata() {
        ...
        Customer customerIon = new Customer("Ion Popescu",
        ...
        Order orderJohn = new Order(customerJohn, Arrays.asList(pizzaOrderMargarita, pizzaOrderPeperoni));

        orderCrudRepository.save(orderJohn);

        PizzaOrder pizzaOrderPeperoniIon = new PizzaOrder(2, pizzaPeperoni);

        Order orderIon = new Order(customerIon, Arrays.asList(pizzaOrderPeperoniIon));
